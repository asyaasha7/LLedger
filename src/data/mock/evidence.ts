...
const SEED: EvidenceItem[] = [
  {
    ...
    description: "Counters, sink, and upper cabinets",
    roomTag: "Kitchen",
    fileHash: H("01"),
  ...
  },
  {
    ...
    category: "Move-In",
    title: "Hallway · floor",
    description: "Full length from entry",
    roomTag: "Hallway",
    fileHash: H("02"),
  ...
  },
  {
    ...
    category: "Move-Out",
    title: "Living room",
    description: "Final walk-through set",
    roomTag: "Living room",
    fileHash: H("03"),
  ...
  },
  {
    ...
    category: "Damage",
    title: "Wall scratch",
    description: "Near entry, right of closet",
    roomTag: "Entry",
    fileHash: H("04"),
